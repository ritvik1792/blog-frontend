...
import NavItem from "../../admin/components/header/NavItem";
import NavItemCollapse from "../../admin/components/header/NavItemCollapse";
  ...
  const { mutate: mutateCreatePost, isLoading: isLoadingCreatePost } =
    useMutation({
      ...
      onSuccess: (data) => {
        ...
        navigate(`/writer/posts/manage/edit/${data.slug}`);
      },
      onError: (error) => {
          ...
          <div className="fixed top-0 bottom-0 left-0 z-50 w-3/4 overflow-y-auto bg-white p-4 lg:static lg:h-full lg:w-full lg:p-6">
            ...
            <div className="mt-6 flex flex-col gap-y-[0.563rem]">
              ...
              <NavItemCollapse
                ...
                setActiveNavName={setActiveNavName}
              >
                <Link to="/writer/posts/manage">Manage my posts</Link>
                <button
